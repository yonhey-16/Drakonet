...
<head>
  ...
  <title>Registro Inventario | DrakoNet</title>
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h5 class="m-0">Formulario de registro de Inventario de Productos</h5>
              </div>
              <form action="../../controller/insertInventarioProductoA.php" method="POST">
                <div class="card-body">
                  <div class="row">
                  <!-- <div class="form-group col-md-6">
                      <label for="inventarioImput">ID Inventario</label>
                      <input type="number" name="idinventario" class="form-control" id="inventarioImput" placeholder="...">
                    </div> -->
                  <div class="form-group col-md-6">
                      <label for="nitproveedorImput">NIT Proveedor</label>
                      <input type="number" name="nitproveedor" class="form-control" id="nitproveedorImput" placeholder="Nit de la empresa del proveedor">
                    </div>
                  <div class="form-group col-md-6">
                      <label for="codigoimput">Codigo del Producto</label>
                      <input type="number" name="codproducto" class="form-control" id="codigoimput" placeholder="Identificador del producto">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="nombreImput">Nombre Producto</label>
                      <input type="text" name="nombreproducto" class="form-control" id="nombreImput" placeholder="Nombre del producto">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="fechaImput">Fecha del movimiento en el inventario</label>
                      <input type="date" name="fecha" class="form-control" id="fechaImput">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" name="precio" class="form-control" id="precioImput" placeholder="Valor del producto">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="causaImput">Causa</label>
                      <select class="form-control" name="causa" id="causaImput">
                        <option value="">Selecciones una opcion</option>
                        <option value="Ingreso">Ingreso del producto</option>
                        <option value="Salida">Salida del producto</option>
                      </select>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="observacionImput">Observaciones</label>
                      <textarea name="observacion" class="form-control" id="observacionImput" cols="30" rows="3"></textarea>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
