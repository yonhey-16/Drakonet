...
<?php 
  ...
  require_once("../../controller/mostrarInventarioProductosA.php");
...
<head>
  ...
  <title>Vista Inventario | DrakoNet</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Inventario de productos registrados en el Sistema</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
