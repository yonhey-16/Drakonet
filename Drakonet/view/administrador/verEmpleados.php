...
<?php 
  ...
  require_once("../../controller/mostrarEmpleadosA.php");
...
<head>
  ...
  <title>Vista Empleados | DrakoNet</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Empleados registrados en el sistema</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
...
<!-- DataTables  & Plugins -->
<!-- el siguiente script es para modificar contenidos de la tabla -->
