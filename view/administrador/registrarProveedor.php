...
<head>
  ...
  <title>Registro Proveedor | DrakoNet</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Registrar proveedores al sistema</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h5 class="m-0">Formulario de registro de proveedores</h5>
              </div>
              <form action="../../controller/insertProveA.php" method="POST">
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label for="nitProvee">NIT proveedor</label>
                      <input type="number" name="nitProveedor" class="form-control" id="nitProvee" placeholder="Nit de la empresa del proveedor">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="nombreEmpresa">Nombre de la empresa del proveedor</label>
                      <input type="text" name="nombreEmpreProvee" class="form-control" id="nombresImput" placeholder="Nombre de la empresa">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="telefonoEmpreProv">Telefono de la empresa del proveedor</label>
                      <input type="number" name="telefonoEmpreProvee" class="form-control" id="telefonoEmpreProv" placeholder="Telefono directo a la empresa">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="direccionProvee">Dirección de la empresa del proveedor</label>
                      <input type="text" name="direccionEmpreProvee" class="form-control" id="direccionProvee" placeholder="Direccion principal de la empresa">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="nombreContacProvee">Nombre del contacto</label>
                      <input type="text" name="nombreContProvee" class="form-control" id="nombreContacProvee" placeholder="Nombre del principal contacto">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="telefonoInput">Telefono del contacto</label>
                      <input type="number" class="form-control" name="telefonoContProvee" id="telefonoInput" placeholder="No. de telefono del contacto">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="correoInput">Correo del contacto</label>
                      <input type="email" class="form-control" name="correoContProvee" id="correoInput" placeholder="email del contacto">
                    </div>
