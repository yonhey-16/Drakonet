...
<head>
  ...
  <title>Registro Cliente | DrakoNet</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Registrar Clientes al sistema</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary">
              ...
              <form action="../../controller/insertClienteA.php" method="POST">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="direccion" class="form-control" id="direccionImput" placeholder="Direccion de residencia">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="emailImput">Email</label>
                      <input type="email" name="email" class="form-control" id="emailImput" placeholder="Email">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" name="telefono" class="form-control" id="telefonoImput" placeholder="No. de telefono fijo (opcional)">
                    </div>
                    <div class="form-group col-md-6">
