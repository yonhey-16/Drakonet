...
<head>
  ...
  <title>Administrador | DrakoNet</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background: url(../../view/client-side/images/home/fondosuave.jpg); background-size: cover;
">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0" style="font-size: 80px; margin-top: 35px; text-align: center; 
            color: white; font-family: 'Cambria'">¡Bienvenido al Sistema!</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
